...
<body>
    ...
    <p>Thank you for signing up as a doctor in our website. To complete your registration, please verify your email
        address
    ...
    <table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td align="center">
                <a href="{{ route('verify.email', ['token' => $doctor->verification_token]) }}"
